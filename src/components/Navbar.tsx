  ...
  return (
    ...
    >
      ...
      <div className="lg:w-[50%]   py-3 lg:flex hidden items-center justify-end gap-5 text-lg">
        <Link
          href={"/"}
          className={scrolled ? "text-gray-900 hover:underline transition-all 0.2s ease-in-out" : "text-gray-200 hover:underline transition-all 0.2s ease-in-out"}
        >
          Home
        </Link>
        <Link
        ...
        <Link
          href={"/contact"}
          className={scrolled ? "text-white bg-gray-900 px-4 py-2 rounded-lg" : "text-gray-200 px-4 py-2 "}
        >
          Get in touch
        </Link>
      </div>
      <div className="lg:hidden flex w-[50%] items-center justify-end">
        <Sheet>
          <SheetTrigger>
                <PanelLeft  className={scrolled ? "text-gray-900" : "text-gray-200"} />
          </SheetTrigger>
          <SheetContent>
            <SheetHeader>
              <SheetTitle>
              ...
              <SheetDescription>
                <div className="flex flex-col gap-5 pt-5 border-b-[0.4px] pb-5">
                  <Link href={'/'} className="w-full text-black bg-whtie text-start text-[20px] flex items-center gap-2 justify-start">
                    <House  /> Home  
                  </Link>


                  <Link href={'/about'} className="w-full text-black bg-whtie text-start text-[20px] flex items-center gap-2 justify-start">
                    <BadgeInfo   /> About us  
                  </Link>


                  <Link href={'/contact'} className="w-full text-black bg-whtie text-start text-[20px] flex items-center gap-2 justify-start">
